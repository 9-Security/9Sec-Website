...
#
# In the monorepo, core/frontend is usually NOT that repo — use instead:
#   NINESEC_PAGES_ROOT=/path/to/9Sec-Website ./deploy-frontend-pages.sh "message"
# (wrapper at repo root: ./deploy-frontend-pages.sh)
#
